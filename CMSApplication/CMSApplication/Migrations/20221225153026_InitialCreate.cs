        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileFile = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientEvaluations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClientEvaluations_Employees_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InternalEvaluations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InternalEvaluations_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EmployeeId = table.Column<int>(type: "int", nullable: false),
                    RoleOnDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RoleOffDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Workings_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientEvaluations_EmployeeId",
                table: "ClientEvaluations",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_InternalEvaluations_EmployeeId",
                table: "InternalEvaluations",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_Workings_EmployeeId",
                table: "Workings",
                column: "EmployeeId");
        }
